...
int main()
{
    ...
    printf("Enter 11 for Inverse\n");
    printf("Enter 12 for Naturallog\n");
    printf("Enter 13 for Logvalue\n");
    printf("Enter 14 for Exponential\n");
    printf("Enter 15 for Power\n");
    printf("Enter 16 for trigonometric operation\n");
    printf("Enter 17 for inverse trigonometric operation\n");
    printf("Enter 18 for hyperbolic trigonometric operation\n");
    printf("Enter 19 for inverse hyperbolic trigonometric operation\n");
    while (1)
    {
